...
public class Products extends TableImpl<ProductsRecord> {
    ...
    /**
     * The column <code>public.products.company_id</code>.
     */
    public final TableField<ProductsRecord, Integer> COMPANY_ID = createField(DSL.name("company_id"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<ForeignKey<ProductsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.PRODUCTS__PRODUCTS_COMPANY_ID_FKEY);
    }

    private transient Companies _companies;
    ...
    public Companies companies() {
        if (_companies == null)
            _companies = new Companies(this, Keys.PRODUCTS__PRODUCTS_COMPANY_ID_FKEY);
